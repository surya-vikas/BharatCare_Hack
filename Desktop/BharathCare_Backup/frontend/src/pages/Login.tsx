...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      } else if (response.role === "pharmacy") {
        navigate("/pharmacy/dashboard", { replace: true });
      } else {
        navigate("/user/dashboard", { replace: true }); // patient
      }
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            A unified platform connecting patients, doctors, and pharmacies for
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 22,
              boxShadow:
                "0 2px 8px rgba(28,47,94,0.06), 0 8px 32px rgba(28,47,94,0.09)",
          ...
          >
              ...
              {(["patient", "doctor", "pharmacy"] as const).map((role) => (
                <button
                  ...
                  style={{
                    ...
                    background:
                      selectedRole === role ? "#FFFFFF" : "transparent",
            ...
            <form onSubmit={handleLogin}>
              ...
              {/* Thin divider */}
              <div
                style={{ height: 1, background: "#EDF2FA", marginBottom: 20 }}
              />
              ...
              <button
                ...
                style={{
                  ...
                  padding: "13px 20px",
                  background:
                    "linear-gradient(135deg, #49B6C6 0%, #38a4b4 100%)",
                  color: "#FFFFFF",
                  border: "none",
                  borderRadius: 12,
                  fontSize: 15,
